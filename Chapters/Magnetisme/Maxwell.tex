...
% \begin{theo}[Vergelijkingen van Maxwell]{Vergelijkingen van Maxwell}
%     \vspace{-0.3cm}
%     \begin{center}
%         \def\arraystretch{2}
%         \begin{tabular}{c|c}
%             Naam & Differentiaalvergelijking \\ \hline
%             Gauss voor elektrische velden & $\oint \Vec{E} \cdot d\Vec{A} = \frac{Q}{\epsilon_0}$ \\
%             Gauss voor magnetische velden & $\oint \Vec{B} \cdot d\Vec{A} = 0$ \\
%             Maxwell-Faraday & $\oint \Vec{E} \cdot d\Vec{\ell} = -\frac{d\Phi_B}{dt}$ \\
%             Ampère-Maxwell & $\oint \Vec{B} \cdot d\Vec{\ell} = \mu_0I + \mu_0 \epsilon_0 \frac{d\Phi_B}{dt}$ \\
%         \end{tabular}
%     \end{center}
% \end{theo}